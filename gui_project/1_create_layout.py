...
btn_add_file = Button(file_frm, padx=5, pady=5, width=12, text='파일추가')
btn_add_file.pack(side="left")

btn_del_file = Button(file_frm, padx=5, pady=5, width=12, text="선택삭제")
...
btn_dest_path = Button(path_frm, text="찾아보기", width=10)
...
btn_start = Button(frm_run, padx=5, pady=5, text="시작", width=12)
