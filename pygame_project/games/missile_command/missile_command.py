...
class House:
    ...
    def __init__(self, xpos):
        ...
        self.exploded = False
        strip = pygame.image.load("pygame_project/games/missile_command/strip.png")
...
class Shoot:
    ...
    def __init__(self):
        self.scope = (400, 300)
        self.image = pygame.image.load("pygame_project/games/missile_command/scope.png")
        self.count = 0
        self.fire = False
        self.radius = 0
        self.shot_pos = (0, 0)
    ...
    def tick(self):
        ...
        if self.fire:
            ...
            if 100 <= self.count <= 300:
                self.radius = 100 * sin((self.count - 100) * pi / 200)
            elif self.count > 300:
                self.fire = False
                self.count = 0
